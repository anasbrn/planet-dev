<div class="flex justify-center">
    <input class="p-2 border mr-2 rounded shadow-sm" type="search" name="searchArticles" id="searchArticles" placeholder="Search articles" style="width: 30%">
...
<div class="flex items-center justify-between">
    <div class="flex items-center">
        <h1 class="font-bold mt-10 mb-5">Articles</h1>
    </div>
    
    <div>
        <button class="bg-orange-500 py-2 px-5 rounded shadow-sm text-white hover:bg-orange-900" data-modal-target="article-modal" data-modal-toggle="article-modal">Add article<i class="fa fa-plus ml-2"></i></button>
    </div>
</div>
...
<table class="table-auto border rounded bg-white" style="width: 100%;">
    <thead>
        <tr class="text-center">
            <th class="border-b-2 border-b-orange-300 px-4 py-2">Name</th>
            <th class="border-b-2 border-b-orange-300 px-4 py-2">Content</th>
...
<!-- Main modal -->
<div id="article-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="#">
                    ...
                    <div>
                        ...
                        <input type="date" name="articleDate" id="articleDate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                    </div>

                    <div>
                        <label for="articleDate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Write your article here</label>
                        <textarea type="text" name="articleDate" id="articleDate" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required></textarea>
                    </div>
